        ...
        <section className="py-16 bg-card">
          <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="w-full h-auto aspect-video relative rounded-lg overflow-hidden shadow-lg">
              <Image src="https://picsum.photos/seed/nyc/1200/800" alt="New York City skyline" data-ai-hint="new york city" fill className="object-cover" />
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
            <div className="w-full h-auto aspect-video relative rounded-lg overflow-hidden shadow-lg order-last md:order-first">
              <Image src="https://picsum.photos/seed/balloons/1200/800" alt="Hot air balloons" data-ai-hint="hot air balloons" fill className="object-cover" />
            </div>
             <div className="text-center md:text-left">
